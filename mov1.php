...
if (!empty($cb1) && empty($cb2) && empty($cb3) && empty($cb4) && empty($cb5)) {
    $sql = "INSERT INTO table_name (review) VALUES ('$username',$cb1',1)";
} else if (!empty($cb1) && !empty($cb2) && empty($cb3) && empty($cb4) && empty($cb5)) {
    $sql = "INSERT INTO table_name (review) VALUES ('$username','$cb2',1)";
} else if (!empty($cb1) && !empty($cb2) && !empty($cb3) && empty($cb4) && empty($cb5)) {
    $sql = "INSERT INTO table_name (review) VALUES ('$username','$cb3',1)";
} else if (!empty($cb1) && !empty($cb2) && empty($cb3) && !empty($cb4) && empty($cb5)) {
    $sql = "INSERT INTO table_name (review) VALUES ('$username','$cb4',1)";
} else if (!empty($cb1) && !empty($cb2) && empty($cb3) && empty($cb4) && !empty($cb5)) {
    $sql = "INSERT INTO table_name (review, moviename) VALUES ('$username','$cb5', 1)";
} else {
